    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          background: '#E8F5EF', color: '#00875A',
        ...
        <div style={{ fontSize: '24px', fontWeight: '600', color: '#0A1628', letterSpacing: '-0.4px', marginBottom: '4px' }}>
          Bon retour
        </div>
        ...
        {/* Role tabs */}
        <div style={{
          display: 'flex', background: '#F0F4FA',
          ...
          {(['admin', 'client'] as const).map((r) => (
            <button
              ...
              style={{
                ...
                color: role === r ? '#0A1628' : '#6B7A99',
                background: role === r ? '#fff' : 'transparent',
                boxShadow: role === r ? '0 1px 4px rgba(10,22,40,0.08)' : 'none',
        ...
        {/* Champs */}
        {[
          { label: 'Adresse e-mail', type: 'email', placeholder: 'nom@structure.fr', value: email, onChange: setEmail },
          { label: 'Mot de passe', type: 'password', placeholder: '••••••••', value: password, onChange: setPassword }
        ].map((f) => (
          <div key={f.label} style={{ marginBottom: '14px' }}>
            <label style={{
              display: 'block', fontSize: '12px', fontWeight: '500',
              color: '#6B7A99', marginBottom: '6px', letterSpacing: '0.2px'
            }}>{f.label}</label>
            <input
              type={f.type}
        ...
        <button
          ...
          style={{
            ...
            background: loading ? '#93AEED' : '#1A56DB',
        ...
        <div style={{
          ...
          marginTop: '24px', fontSize: '12px', color: '#B0BCCE'
        }}>
          <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#00B37E" strokeWidth="2.5">
