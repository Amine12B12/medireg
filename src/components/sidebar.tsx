...
const navAdmin = [
  ...
  { label: 'Devis', path: '/dashboard/devis', icon: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/></svg> },
]
const navClient = [
  { label: 'Tableau de bord', path: '/dashboard', icon: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="3" y="3" width="7" height="7"/><rect x="14" y="3" width="7" height="7"/><rect x="3" y="14" width="7" height="7"/><rect x="14" y="14" width="7" height="7"/></svg> },
  ...
  { label: 'Maintenance', path: '/dashboard/maintenance', icon: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76z"/></svg> },
  { label: 'Alertes', path: '/dashboard/alertes', icon: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"/><path d="M13.73 21a2 2 0 0 1-3.46 0"/></svg>, badge: 1 },
  { label: 'Demande de devis', path: '/dashboard/devis', icon: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/></svg> },
]
export default function Sidebar({ role }: Props) {
  ...
  return (
    <div style={{ width: '220px', minHeight: '100vh', background: '#fff', borderRight: '0.5px solid #DDE5F0', display: 'flex', flexDirection: 'column', padding: '0', flexShrink: 0, fontFamily: 'Inter, -apple-system, sans-serif' }}>
        ...
        {nav.map(item => {
          ...
          return (
            <button key={item.path} onClick={() => router.push(item.path)}
              style={{ width: '100%', display: 'flex', alignItems: 'center', gap: '10px', padding: '9px 12px', borderRadius: '8px', border: 'none', background: active ? '#EEF2FF' : 'transparent', color: active ? '#1A56DB' : '#6B7A99', fontSize: '13px', fontWeight: active ? '500' : '400', cursor: 'pointer', fontFamily: 'inherit', marginBottom: '2px', textAlign: 'left', transition: 'all 0.1s', position: 'relative' }}
            ...
            >
              ...
              {(item as any).badge && (
                <span style={{ background: '#DC2626', color: '#fff', fontSize: '10px', fontWeight: '600', padding: '2px 6px', borderRadius: '10px' }}>{(item as any).badge}</span>
              )}
            </button>
          )
        })}
